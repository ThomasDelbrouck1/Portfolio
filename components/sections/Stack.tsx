...
const catStyle: Record<Category, {
  ...
  "Language": {
    ...
    pill:         "bg-white/[0.05] text-slate-600 dark:text-slate-300 hover:bg-violet-500/[0.16] hover:text-violet-700 dark:hover:text-violet-300",
  ...
  "Framework": {
    ...
    pill:         "bg-white/[0.05] text-slate-600 dark:text-slate-300 hover:bg-teal-500/[0.16] hover:text-teal-700 dark:hover:text-teal-300",
  ...
  "Database": {
    ...
    pill:         "bg-white/[0.05] text-slate-600 dark:text-slate-300 hover:bg-blue-500/[0.16] hover:text-blue-700 dark:hover:text-blue-300",
  ...
  "DevOps": {
    ...
    pill:         "bg-white/[0.05] text-slate-600 dark:text-slate-300 hover:bg-cyan-500/[0.16] hover:text-cyan-700 dark:hover:text-cyan-300",
  ...
  "Tooling": {
    ...
    pill:         "bg-white/[0.05] text-slate-600 dark:text-slate-300 hover:bg-emerald-500/[0.16] hover:text-emerald-700 dark:hover:text-emerald-300",
  ...
  "ML / AI": {
    ...
    pill:         "bg-white/[0.05] text-slate-600 dark:text-slate-300 hover:bg-fuchsia-500/[0.16] hover:text-fuchsia-700 dark:hover:text-fuchsia-300",
