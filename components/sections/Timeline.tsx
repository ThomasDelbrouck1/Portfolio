...
const typeStyles = {
  education: {
    ...
    badge:    "bg-blue-500/15 border-blue-400/50 text-blue-800 dark:bg-blue-500/30 dark:border-blue-400/70 dark:text-blue-200",
  ...
  project: {
    ...
    badge:    "bg-violet-500/15 border-violet-400/50 text-violet-800 dark:bg-violet-500/30 dark:border-violet-400/70 dark:text-violet-200",
  ...
  milestone: {
    ...
    badge:    "bg-cyan-500/15 border-cyan-400/50 text-cyan-800 dark:bg-cyan-500/30 dark:border-cyan-400/70 dark:text-cyan-200",
  ...
  upcoming: {
    ...
    badge:    "bg-amber-500/15 border-amber-400/50 text-amber-800 dark:bg-amber-500/30 dark:border-amber-400/70 dark:text-amber-200",
