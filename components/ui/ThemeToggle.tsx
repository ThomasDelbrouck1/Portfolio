...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-8 h-8 flex items-center justify-center rounded-lg glass text-slate-600 dark:text-slate-400 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-200"
    >
