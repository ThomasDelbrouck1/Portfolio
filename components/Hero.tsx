      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 w-full">
        ...
        <div className="flex flex-wrap gap-3">
          <a
            ...
            className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-xl bg-violet-600/15 border border-violet-500/25 text-violet-300 font-mono text-sm hover:bg-violet-600/25 hover:border-violet-500/45 hover:shadow-lg hover:shadow-violet-500/10 transition-all duration-200"
          >
            <GitHubIcon />
            GitHub
